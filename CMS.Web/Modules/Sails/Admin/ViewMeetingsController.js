moduleViewMeetings.controller("getActivityByIdController", ["$rootScope", "$scope", "$http", "$location", "$filter", "$timeout", function ($rootScope, $scope, $http, $location, $filter, $timeout) {
