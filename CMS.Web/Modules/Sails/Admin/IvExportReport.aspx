<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IvExportReport.aspx.cs" MasterPageFile="MO.Master" Inherits="Portal.Modules.OrientalSails.Web.Admin.IvExportReport" %>

<asp:Content ID="Content2" ContentPlaceHolderID="AdminContent" runat="server">
    <fieldset>
        <legend>BÁO CÁO DOANH THU</legend>
        <div class="group">
                    ...
                    <asp:Repeater ID="rptProductList" runat="server" OnItemDataBound="rptProductList_ItemDataBound">
                        <HeaderTemplate>
                            <tr class="item">
                                ...
                                <th style="width: 8%">Thực thu
                                </th>
                                <th style="width: 8%">Số khách
                                </th>
