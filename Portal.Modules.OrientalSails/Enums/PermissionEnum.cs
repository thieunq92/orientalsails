...
namespace Portal.Modules.OrientalSails.Enums
{
    public enum PermissionEnum
    {
        ...
        VIEWALLSERIES = 54,
        CANCELALLSERIES = 55,
        AllowExportDebtReceivables = 56,
        AllowAccessReportDebtReceivablePage = 57,
        VIEW_HOME_BOOKING = 72,
        VIEW_HOME_PLAN = 73,
        DASHBOARD_ACESS = 74,
        DASHBOARDMANAGER_ACCESS = 75,
        FORM_IVSTORAGELIST = 61,
        FORM_VOUCHEREDIT = 77,
        FORM_VOUCHERLIST = 78,
        FORM_VOUCHERTEMPLATES = 79,
        FORM_AGENCYLOCATIONS = 80,
        FORM_TRANSACTIONHISTORY = 81,
        FORM_REPORTDEBTRECEIVABLES = 82,
