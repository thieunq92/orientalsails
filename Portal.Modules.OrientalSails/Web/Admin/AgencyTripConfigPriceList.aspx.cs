...
{
    public partial class AgencyTripConfigPriceList : SailsAdminBasePage
    {
        ...
        {
            int count = 0;
            rptTripPrice.DataSource = Module.GetAgencyTripPriceConfig(pagerProduct.PageSize, pagerProduct.CurrentPageIndex, out count);
