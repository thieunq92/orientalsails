<%@ Page Title="" Language="C#" MasterPageFile="MO.Master" AutoEventWireup="true" CodeBehind="AgencyTripConfigPriceAdd.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.AgencyTripConfigPriceAdd" %>

<%@ Register Src="Controls/CruisePriceConfig.ascx" TagPrefix="uc1" TagName="CruisePriceConfig" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <title>Cập nhật giá theo cấp đại lý</title>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="AdminContent" runat="server">
            ...
            <fieldset class="price-cruise">
                <legend>
                    <div class="page-header">
                        <h3>Cập nhật giá theo cấp đại lý</h3>
                    </div>
                </legend>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <asp:DropDownList ID="ddlAgentLevel" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAgentLevel_OnSelectedIndexChanged" class="form-control">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <asp:Button runat="server" ID="btnSave" OnClick="btnSave_OnClick" Text="Lưu giá đại lý" CssClass="btn btn-success" />
    ...
    <script>
        function backList() {
            window.location.href = '/Modules/Sails/Admin/AgencyTripConfigPriceList.aspx?NodeId=1&SectionId=15';
        }
    </script>
</asp:Content>
