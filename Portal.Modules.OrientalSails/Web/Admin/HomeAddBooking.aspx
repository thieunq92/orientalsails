<%@ Page Title="" Language="C#" MasterPageFile="NewPopup.Master" AutoEventWireup="true" CodeBehind="HomeAddBooking.aspx.cs" Inherits="Portal.Modules.OrientalSails.Web.Admin.HomeAddBooking" %>

<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    <script>
        function RefreshParentPage(url) {
            window.parent.closePoup2(url);
        }
        function closePoup() {
